...
Defined by `frontend/src-tauri/eo-services/src/lib.rs`. This crate carries the service layer behind the command facade, built up service by service over the course of the migration. Its modules group as follows:
