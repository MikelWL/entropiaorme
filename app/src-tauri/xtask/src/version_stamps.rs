...
//!   - `app/src-tauri/Cargo.toml` (`[workspace.package] version`),
//!   - `app/src-tauri/entropia-orme/tauri.conf.json` (`version`).
//!
//! `CURRENT_TOS_VERSION` in `app/src/lib/tos.ts` is deliberately NOT part
...
const PACKAGE_JSON: &str = "app/package.json";
const CARGO_TOML: &str = "app/src-tauri/Cargo.toml";
const TAURI_CONF: &str = "app/src-tauri/entropia-orme/tauri.conf.json";
...
app/src/lib/tos.ts is a separate namespace and is intentionally \
