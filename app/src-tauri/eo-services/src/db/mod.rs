...
mod tests {
    ...
    async fn baseline_creates_the_full_schema_surface_and_version_row() {
        ...
        // waiting indexes = 73 tables, 93 indexes, 10 triggers.
        assert_eq!(count("table").await, 73);
        assert_eq!(count("index").await, 93);
