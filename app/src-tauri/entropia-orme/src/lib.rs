...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::session_definition_delete,
            ...
            commands::tracking_segment_open,
            commands::tracking_segment_close,
            commands::tracking_segment_rename,
            commands::tracking_quest_focus,
            commands::tracking_quest_unfocus,
            commands::tracking_focus_options,
